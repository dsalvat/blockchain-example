...
describe('Wallet', () => {
  ...
  describe('creating transaction', () => {
    ...
    beforeEach(() => {
      recipientAddress = 'r4nf0m-4ddr3ss';
      amount = 5;
  ...
  describe('calulating a balance', () => {
    ...
    it('calculates the balance for the blockchain txs matching the recipient', () => {
      expect(wallet.currentBalance).toEqual(INITIAL_BALANCE + (addBalance * times));
    });

    it('calculates the balance for the blockchain txs matching the sender', () => {
